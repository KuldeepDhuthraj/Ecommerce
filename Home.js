...
function changeBgImagOfAds() {
  var divDomElement = document.querySelector(".trendingProductsAd");
  var AdTitle = document.getElementById("adTitle");
  setInterval(function () {
    if (divDomElement.getAttribute("name") === "image1") {
      console.log(AdTitle);
      AdTitle.textContent = "Play. Dress. Repeat";
      divDomElement.style.backgroundImage =
        "linear-gradient(rgba(0,0,0,0.8)),url('https://static.vecteezy.com/system/resources/previews/026/911/393/non_2x/fashion-model-kids-free-photo.jpg')";
      divDomElement.setAttribute("name", "image2");
    } else if (divDomElement.getAttribute("name") === "image2") {
      AdTitle.textContent = "Everyday Comfort, Endless Fun";
      divDomElement.style.backgroundImage =
        "linear-gradient(rgba(0,0,0,0.8)),url('https://img.freepik.com/premium-photo/fashion-model-kids_115919-23246.jpg')";
      divDomElement.setAttribute("name", "image3");
    } else if (divDomElement.getAttribute("name") === "image3") {
      AdTitle.textContent = "Cute Looks for Tiny Trendsetters";
      divDomElement.style.backgroundImage =
        "linear-gradient(rgba(0,0,0,0.8)),url('https://img.freepik.com/premium-photo/stylish-cute-kids-posing-color-background-stylish-cute-kids-posing-colorful-bg_483187-7653.jpg?w=2000')";
      divDomElement.setAttribute("name", "image4");
    } else if (divDomElement.getAttribute("name") === "image4") {
      AdTitle.textContent = "Little Styles, Big Smiles";
      divDomElement.style.backgroundImage =
        "linear-gradient(rgba(0,0,0,0.8)),url('https://bluejay.com.my/wp-content/uploads/2021/12/Kids-clothes-Hong-Kong-seed.jpg')";
      divDomElement.setAttribute("name", "image1");
    }
  }, 2000);
}